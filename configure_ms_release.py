...
entries_ms_type = ('full', 'acer', 'panel')
...
class Configuration:
    ...
    def print(self):
        ...
        print("\nREMEMBER TO MANUALLY UPDATE THE ANDROID CODE!\n")
    ...
    def update_ms_type(self):
        if self.ms_type not in entries_ms_type:
            print("Cannot update ms_type. Value not valid: " + self.ms_type)
    ...
    def update_debug(self):
        ...
        #        lines[i] = 'project.ext.set("developmentBuild", ' + (('1' if self.debug == 'true' else '0') + ')\n')
        #self.write_file(path, lines)
